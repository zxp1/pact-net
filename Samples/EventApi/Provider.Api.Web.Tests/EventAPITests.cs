        ...
        public void EnsureEventApiHonoursPactWithConsumer()
        {
            ...
            var pact = new Pact()
                ...
                new Dictionary<string, Action>
                {
                    ...
                    { "There is at least one event with type 'SearchView'", EnsureASearchViewEventExists },
                    { "There is at least one event with type grouping 'Search'", EnsureASearchViewEventExists }
                });
